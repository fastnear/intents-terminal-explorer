 ...
 * @param {string} qs
 */
export function nearx_auth_callback(qs) {
    const ptr0 = passStringToWasm0(qs, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.nearx_auth_callback(ptr0, len0);
}

function __wbg_adapter_6(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h587cba88676c7b3d(arg0, arg1);
}
...
function __wbg_adapter_14(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h6e77dd5eeaa1b49e(arg0, arg1);
}
...
export class WasmApp {
    ...
    snapshot_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmapp_snapshot_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @returns {string}
     */
    handle_action_json(action_json) {
        let deferred2_0;
        let deferred2_1;
        try {
            const ptr0 = passStringToWasm0(action_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmapp_handle_action_json(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) WasmApp.prototype[Symbol.dispose] = WasmApp.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_4ebb9911410fd400 = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 169, __wbg_adapter_6);
        return ret;
    };
    imports.wbg.__wbindgen_cast_ab203f1eba1f23b3 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 410, function: Function { arguments: [Externref], shim_idx: 411, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        const ret = makeMutClosure(arg0, arg1, 410, __wbg_adapter_9);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_cast_e024e09672c16c3c = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, 297, __wbg_adapter_14);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('nearx-web-dom_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
